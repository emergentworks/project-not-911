...
export default function NoiseNuisancesScreen(props: any) {
    // @ts-ignore
    const numbers = PhoneNumbers[props.route.name];

    return (
    <View style={styles.container}>
        <Text style={styles.title}>Noise / Nuisances</Text>
        ...
        <EditScreenInfo path="/screens/NoiseNuisancesScreen.tsx" />
    </View>
    );
}
